import torch
import os
from algorithms.qmix.network.rnn import RNN
from algorithms.qmix.network.qmix_net import QMixNet
...
class QMIX:
    def __init__(self, args):
        ...
        self.model_dir = args.model_dir + '/' + args.date_dir 
        # 如果存在模型则加载模型
        ...
        # path_rnn = self.model_dir + '/5180-1.0-234.0-_rnn_net_params.pkl'
        # path_qmix = self.model_dir + '/5180-1.0-234.0-_qmix_net_params.pkl'
    ...
    def save_model(self, train_step,  win_rate, episode_reward):
        num = str(train_step // self.args.save_cycle)
        if not os.path.exists(self.model_dir):
            os.makedirs(self.model_dir)
        torch.save(self.eval_qmix_net.state_dict(), self.model_dir + '/' + num + "-" + (str)(win_rate) + "-" +  (str)(episode_reward) + "-" + '_qmix_net_params.pkl')
        torch.save(self.eval_rnn.state_dict(),  self.model_dir + '/' + num + "-" + (str)(win_rate) + "-" +  (str)(episode_reward) + "-"  +'_rnn_net_params.pkl')
